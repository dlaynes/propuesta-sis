      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Camera className="w-5 h-5 text-white/70 hover:text-white cursor-pointer" />
            <MessageCircle className="w-5 h-5 text-white/70 hover:text-white cursor-pointer" />
            <Video className="w-5 h-5 text-white/70 hover:text-white cursor-pointer" />
          </div>
        </div>
